...
- **`npm run setup-builder`** - Configure your Polymarket Builder code (see below)
- **`npm run preview`** - Preview the built extension (rarely used)

## Polymarket Builder Program

Earn rewards by referring users to Polymarket! All links generated by this extension can include your builder code.

### Setup

1. **Get your builder address:**
   - Visit: https://polymarket.com/settings?tab=builder
   - Sign in and create your builder profile
   - Copy your Builder Address
...
2. **Configure the extension:**
   ...
   # Edit .env and add your builder address
   # BUILDER_ADDRESS=0xYourAddressHere
...
3. **Verify it's working:**
   - All Polymarket links will now include `?builder=YOUR_ADDRESS`
   - Track your stats at: https://builders.polymarket.com/

### How It Works

- Every link to Polymarket includes your builder parameter
- You earn rewards based on trading volume from your referrals
- View your stats on the [Builder Leaderboard](https://builders.polymarket.com/)
- No API keys needed for link attribution

For more info, see: https://docs.polymarket.com/developers/builders
